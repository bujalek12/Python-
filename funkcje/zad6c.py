...
@wrapper_with_log_file('FILE_CREATE',r'C:\Users\48530\Desktop\visual\pomoc\file_create.txt')
def create_file(path):
    print('creating file {}'.format(path))
    open(path,"w+")
 
@wrapper_with_log_file('FILE_DELETE',r'C:\Users\48530\Desktop\visual\pomoc\file_delete.txt')
